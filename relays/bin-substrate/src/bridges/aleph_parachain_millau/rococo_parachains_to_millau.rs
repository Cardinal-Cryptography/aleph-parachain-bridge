...
impl MessagesCliBridge for AlephParachainToMillauCliBridge {
	type MessagesLane =
	crate::bridges::aleph_parachain_millau::aleph_parachain_messages_to_millau::AlephParachainMessagesToMillau;
}
