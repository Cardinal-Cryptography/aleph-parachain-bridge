...
substrate_relay_helper::generate_receive_message_delivery_proof_call_builder!(
	AlephParachainMessagesToMillau,
	AlephParachainMessagesToMillauReceiveMessagesDeliveryProofCallBuilder,
	relay_aleph_parachain_client::RuntimeCall::BridgeMillauMessages,
	relay_aleph_parachain_client::BridgeMessagesCall::receive_messages_delivery_proof
);

/// Description of AlephParachain -> Millau messages bridge.
#[derive(Clone, Debug)]
pub struct AlephParachainMessagesToMillau;

impl SubstrateMessageLane for AlephParachainMessagesToMillau {
	type SourceChain = AlephParachain;
