...
//! EXECUTED COMMAND: ./tools/runtime-codegen/target/debug/runtime-codegen --from-node-url http://localhost:39721
...
pub mod api {
			...
			impl StorageApi {
					...
					::subxt::metadata::DecodeStaticType<
						::std::vec::Vec<
							runtime_types::frame_system::EventRecord<
								runtime_types::aleph_parachain_runtime::RuntimeEvent,
								::subxt::utils::H256,
							>,
						>,
					>,
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							35u8, 45u8, 145u8, 141u8, 254u8, 167u8, 185u8, 91u8, 121u8, 116u8,
							121u8, 6u8, 150u8, 187u8, 166u8, 128u8, 99u8, 161u8, 218u8, 126u8,
							217u8, 153u8, 198u8, 23u8, 86u8, 212u8, 44u8, 101u8, 121u8, 121u8,
							192u8, 146u8,
						],
					)
				}
	...
	pub mod collator_selection {
		...
		pub mod calls {
			...
			pub struct SetInvulnerables {
				pub new: ::std::vec::Vec<::sp_core::crypto::AccountId32>,
			}
			#[derive(
				:: subxt :: ext :: codec :: CompactAs,
				:: subxt :: ext :: codec :: Decode,
			...
			impl TransactionApi {
				...
				pub fn set_invulnerables(
					&self,
					new: ::std::vec::Vec<::sp_core::crypto::AccountId32>,
		...
		pub mod events {
			...
			pub struct NewInvulnerables {
				pub invulnerables: ::std::vec::Vec<::sp_core::crypto::AccountId32>,
			}
	...
	pub mod session {
		...
		pub mod calls {
			...
			pub struct SetKeys {
				pub keys: runtime_types::aleph_parachain_runtime::SessionKeys,
			...
			impl TransactionApi {
				...
				pub fn set_keys(
					&self,
					keys: runtime_types::aleph_parachain_runtime::SessionKeys,
			...
			impl StorageApi {
				...
				pub fn queued_keys(
					...
					::subxt::metadata::DecodeStaticType<
						::std::vec::Vec<(
							::sp_core::crypto::AccountId32,
							runtime_types::aleph_parachain_runtime::SessionKeys,
						)>,
					>,
					::subxt::storage::address::Yes,
					::subxt::storage::address::Yes,
		...
		pub mod storage {
			...
			impl StorageApi {
				...
				pub fn remote_locked_fungibles(
					&self,
					_0: impl ::std::borrow::Borrow<::core::primitive::u32>,
					_1: impl ::std::borrow::Borrow<::sp_core::crypto::AccountId32>,
	...
	pub mod bridge_millau_messages {
		...
		pub mod events {
			...
			pub struct MessagesReceived (pub :: std :: vec :: Vec < runtime_types :: bp_messages :: ReceivedMessages < runtime_types :: bridge_runtime_common :: messages_xcm_extension :: XcmBlobMessageDispatchError > > ,) ;
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						[
							107u8, 232u8, 87u8, 193u8, 178u8, 167u8, 114u8, 94u8, 196u8, 9u8,
							116u8, 250u8, 227u8, 102u8, 68u8, 78u8, 230u8, 8u8, 151u8, 212u8, 38u8,
							165u8, 200u8, 194u8, 156u8, 100u8, 188u8, 249u8, 85u8, 181u8, 233u8,
							108u8,
						],
					)
				}
	...
	pub mod sudo {
		...
		pub mod calls {
			...
			pub struct Sudo {
				pub call: ::std::boxed::Box<runtime_types::aleph_parachain_runtime::RuntimeCall>,
			}
			#[derive(
				:: subxt :: ext :: codec :: Decode, :: subxt :: ext :: codec :: Encode, Clone, Debug,
			)]
			...
			impl TransactionApi {
				...
				pub fn sudo(
					&self,
					call: runtime_types::aleph_parachain_runtime::RuntimeCall,
					...
					::subxt::tx::StaticTxPayload::new(
						...
						[
							204u8, 215u8, 77u8, 103u8, 31u8, 68u8, 245u8, 153u8, 105u8, 214u8,
							156u8, 55u8, 243u8, 136u8, 214u8, 133u8, 121u8, 228u8, 103u8, 251u8,
							233u8, 192u8, 245u8, 75u8, 210u8, 244u8, 82u8, 6u8, 113u8, 158u8,
							254u8, 239u8,
						],
					)
				}
				...
				pub fn sudo_unchecked_weight(
					...
					::subxt::tx::StaticTxPayload::new(
						...
						[
							229u8, 162u8, 5u8, 192u8, 26u8, 76u8, 48u8, 29u8, 72u8, 243u8, 82u8,
							27u8, 49u8, 214u8, 176u8, 115u8, 82u8, 229u8, 2u8, 37u8, 19u8, 156u8,
							36u8, 69u8, 133u8, 182u8, 91u8, 119u8, 38u8, 4u8, 141u8, 208u8,
						],
					)
				}
				...
				pub fn sudo_as(
					...
					::subxt::tx::StaticTxPayload::new(
						...
						[
							218u8, 128u8, 52u8, 10u8, 243u8, 205u8, 160u8, 45u8, 89u8, 126u8,
							200u8, 74u8, 236u8, 111u8, 187u8, 114u8, 194u8, 100u8, 53u8, 251u8,
							196u8, 175u8, 77u8, 77u8, 204u8, 159u8, 106u8, 149u8, 163u8, 81u8,
							253u8, 31u8,
						],
					)
				}
	...
	pub mod runtime_types {
		use super::runtime_types;
		pub mod aleph_parachain_runtime {
			use super::runtime_types;
			#[derive(
				:: subxt :: ext :: codec :: Decode, :: subxt :: ext :: codec :: Encode, Clone, Debug,
			)]
		...
		pub mod bp_runtime {
			...
			pub mod messages {
				...
				pub struct MessageDispatchResult<_0> {
					...
					pub dispatch_result: ::core::result::Result<(), _0>,
				}
			}
			#[derive(
				:: subxt :: ext :: codec :: Decode, :: subxt :: ext :: codec :: Encode, Clone, Debug,
		...
		pub mod pallet_sudo {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					sudo {
						call:
							::std::boxed::Box<runtime_types::aleph_parachain_runtime::RuntimeCall>,
					},
					#[codec(index = 1)]
					#[doc = "Authenticates the sudo key and dispatches a function call with `Root` origin."]
					#[doc = "This function does not check the weight of the call, and instead allows the"]
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				237u8, 44u8, 198u8, 40u8, 99u8, 125u8, 192u8, 214u8, 68u8, 140u8, 96u8, 52u8, 22u8,
				71u8, 238u8, 62u8, 225u8, 233u8, 213u8, 180u8, 68u8, 193u8, 220u8, 24u8, 153u8,
				169u8, 247u8, 184u8, 105u8, 220u8, 146u8, 64u8,
			] {
