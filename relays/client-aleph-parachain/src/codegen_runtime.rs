...
//! EXECUTED COMMAND: tools/runtime-codegen/target/debug/runtime-codegen --from-node-url http://localhost:36035
...
pub mod api {
			...
			impl StorageApi {
				...
				> {
					::subxt::storage::address::StaticStorageAddress::new(
						...
						vec![],
						[
							235u8, 103u8, 67u8, 206u8, 91u8, 223u8, 151u8, 183u8, 193u8, 92u8,
							157u8, 3u8, 148u8, 107u8, 194u8, 98u8, 24u8, 116u8, 109u8, 59u8, 21u8,
							81u8, 240u8, 160u8, 71u8, 125u8, 29u8, 75u8, 27u8, 101u8, 216u8, 36u8,
						],
					)
				}
	...
	pub fn validate_codegen<T: ::subxt::Config, C: ::subxt::client::OfflineClientT<T>>(
		...
		if runtime_metadata_hash !=
			[
				158u8, 17u8, 69u8, 236u8, 183u8, 76u8, 150u8, 143u8, 168u8, 88u8, 54u8, 196u8,
				230u8, 222u8, 89u8, 70u8, 165u8, 202u8, 89u8, 33u8, 220u8, 238u8, 167u8, 242u8,
				212u8, 202u8, 1u8, 227u8, 200u8, 225u8, 23u8, 173u8,
			] {
